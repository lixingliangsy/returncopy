 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="returncopy" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "returncopy";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "returncopy") + "_chat_session";
