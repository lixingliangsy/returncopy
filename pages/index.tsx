  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://returncopy.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is ReturnCopy?", "acceptedAnswer": {"@type": "Answer", "text": "ReturnCopy generates return/refund policy and reply drafts for e-commerce teams."}}, {"@type": "Question", "name": "Who should use it?", "acceptedAnswer": {"@type": "Answer", "text": "Merchants and CX leads writing or refreshing return policies."}}, {"@type": "Question", "name": "Is it legal advice?", "acceptedAnswer": {"@type": "Answer", "text": "No. It drafts communications; local consumer law and counsel still win."}}, {"@type": "Question", "name": "What do I provide?", "acceptedAnswer": {"@type": "Answer", "text": "Your store context, return window, and any special constraints."}}, {"@type": "Question", "name": "Can it draft customer replies too?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. It can draft customer-facing return replies alongside policy text."}}, {"@type": "Question", "name": "Does it guarantee compliance?", "acceptedAnswer": {"@type": "Answer", "text": "No. Deterministic checks help catch risky phrasing; jurisdiction review stays with you."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">ReturnCopy - definition</h2>
