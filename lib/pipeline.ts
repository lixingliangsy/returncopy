...
export const PIPELINE_ID = 'returncopy-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Store policy context",
  process: "Step 2/3 · Draft return/refund copy",
  output: "Step 3/3 · Customer-ready return policy",
}
